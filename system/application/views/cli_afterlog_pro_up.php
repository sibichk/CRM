...
<div id="main">
	...
	<div id="middle">
		<div id="left-column">
      	...
      	<div class="cnt">
    	<form action="<?php echo base_url();?>index.php/welcome/pro_regn" method="post" name="registration" enctype="multipart/form-data"> 
                  <table>
					...
					<!--<tr><td>product image</td><td><input id="file_upload" type="file" name="file_upload1" />
</td></tr>-->

	...
	<div id="middle">
		<div id="left-column">
          ...
          <div  id="center">
          			WRONG PASSWORD :p
    		 <?php 
              $attributes = array('name' => 'users' , 'onsubmit' =>"return passwordval()");
			  echo form_open('welcome/ch_ps1',$attributes);?>
                  <table>
                     <tr><td> Enter current password</td><td><input type="password" id="pass" name="pass"/></td></tr>
                     <tr><td> Enter new password</td><td><input type="password" id="pass1" name="pass1" /></td></tr>
                     <tr><td> Confirm password</td><td><input type="password" id="pass2" name="pass2" /></td></tr>

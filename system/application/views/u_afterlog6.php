		...
		<div id="left-column">
			...
			<ul class="nav"> 
                ...
                <li><a href="<?php echo base_url();?>index.php/welcome/login_check">Sign Out</a></li>
                  ...
                  <table> Complain Registed Successfully.Our Administrator will contact you in a short while
                  <a href="<?php echo base_url();?>index.php/welcome/com"><input type="button" id="button" value="Go Back" /></a>
            </table>
		</div>
